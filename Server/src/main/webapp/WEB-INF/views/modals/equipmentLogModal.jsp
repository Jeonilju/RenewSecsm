...
<script type="text/javascript">
	...
	function rentBackEquipment(logId, accountId, equipmentItemsId){

		var param = "logId" + "=" + logId + "&" + 
					"accountId" + "=" + accountId + "&" +
					"equipmentItemsId" + "=" + equipmentItemsId;
		
		$.ajax({
		url : "/Secsm/api_rentBackEquipment",
		type : "POST",
		data : param,
		cache : false,
		async : false,
		...
		success : function(response) {	
			...
			else
			{
				...
				for(i=0;i<Object.keys(obj).length;i++){
					tableContent = tableContent + '<tr> <td class="col-md-1">' + obj[i].equipmentItemsId + '</td> <td class="col-md-4">' + obj[i].equipmentItemsName
									+ '</td> <td class="col-md-2">' + obj[i].strStartDate + '</td> <td class="col-md-2">' + obj[i].strEndDate
									+ '</td> <td class="col-md-2">' + obj[i].accountName;
					if(obj[i].status=="1"){
						tableContent = tableContent + '</td> <td class="col-md-1"> <button type="button" class="btn btn-success"  onclick="rentBackEquipment('
										+ obj[i].id + ',' + obj[i].accountId + ',' + obj[i].equipmentItemsId + ')">반납</button> </td> </tr>';	
					}
...
<div class="modal fade" id="equipmentLogModal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form name="equipmentLog" id="equipmentLog">
				<div class="modal-header">
					<h4 class="modal-title">대여로그</h4>
				</div>
				<div class="modal-body" >
					<div id=equipmentLogTable>
				...
				<div class="modal-footer form-inline">
					...
					<button type="button" class="btn btn-default" onclick="logEquipment(0);">검색</button>
