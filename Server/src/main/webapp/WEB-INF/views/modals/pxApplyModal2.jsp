							...
							<%
								...
								for (PxReqInfo info : pxReqList){
									...
									if(info.getStatus() == 0){
										...
										out.print("<td>"+"<button type = 'button' class='btn btn-default' id = 'refund' onclick = 'accept("+ info.getId()+");'>승인</button>"+"</td>");
									}
									else if((info.getStatus() == 1)){
										out.println("<td>" + "승인" + "</td>");
										out.print("<td>"+"<button type = 'button' class='btn btn-default' id = 'refund' onclick = 'delete("+ info.getId()+");'>삭제</button>"+"</td>");
									}
									out.println("</tr>");
								}
							%>
