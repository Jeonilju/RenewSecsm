...
<script type="text/javascript">
	...
	function addCategory(){
		...
		$.ajax({
		url : "/Secsm/api_equipmentAddCategory",
		type : "POST",
		data : param,
		cache : false,
		async : false,
	...
	function deleteCategory(){
		...
		var param = "categoryOption" + "=" + $("#categoryOption option:selected").val();
		if(confirm("해당 카테고리를 삭제하면 카테고리의 관련 장비들이 모두 삭제됩니다.\n삭제하시겠습니까?"))
		
		$.ajax({
		url : "/Secsm/api_equipmentDeleteCategory",
		type : "POST",
		data : param,
		cache : false,
		async : false,
		...
		success : function(response) {	
			...
			{
				alert('해당 카테고리의 장비들을 다른 카테고리로 변경한 후 시도하세요.');
			}
...
<!-- 장비 카테고리 모달-->
<div class="modal fade" id="equipmentCategoryModal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<form name="equipmentCategory" id="equipmentCategory">
